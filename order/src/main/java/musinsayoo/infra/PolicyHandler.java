...
public class PolicyHandler {
    ...
    @StreamListener(
        value = KafkaProcessor.INPUT,
        condition = "headers['type']=='ClothIncreased'"
    )
    public void wheneverClothIncreased_NotifyWaitCustomer(
        @Payload ClothIncreased clothIncreased
    ) {
        ClothIncreased event = clothIncreased;
        System.out.println(
            "\n\n##### listener NotifyWaitCustomer : " + clothIncreased + "\n\n"
        );
