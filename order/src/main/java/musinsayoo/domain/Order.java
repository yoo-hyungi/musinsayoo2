...
import musinsayoo.domain.Canceled;
import musinsayoo.domain.Ordered;
...
public class Order {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void notifyWaitCustomer(ClothIncreased clothIncreased) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(clothIncreased.get???()).ifPresent(order->{
